    ...
    <div class="flex flex-wrap h-screen">
        <div class="w-full md:w-2/3 order-2 md:order-1 bg-gray-800 md:h-auto flex justify-center items-center">
            <div class="p-auto">
                ...
                <h1 class="text-2xl text-white font-bold pt-6 px-6">Lupa Password</h1>
                <p class="text-white text-lg py-4 px-6">
                    Hal-hal yang perlu diketahui <br>
                    <b>
                        <ul class="list-disc text-green-400 text-lg px-10">
                            <li>Lupa password berfungsi untuk user yang amnesia atau lupa tentang passwordnya sendiri</li>
                            <li>Fitur lupa password terdapat 2 inputan yaitu email dan nim. <br> Dimana jika salah satu inputan yang dimasukkan salah maka.. ya taulah ya</li>
                        </ul>
                    </b>
                </p>
            </div>
        ...
        <div class="w-full md:w-1/3 order-1 md:order-2 bg-blue-900 md:h-auto flex justify-center items-center">
            <div class="w-full max-w-md p-4 m-auto bg-blue-900 border-gray-200 sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="flex flex-col items-center mt-5 pb-8">
                    ...
                    <h5 class="text-2xl font-bold mt-2 text-white dark:text-white">Lupa Password</h5>
                </div>

                <form class="space-y-2 mt-5 mb-5 mx-2" action="/store-lupa-password" method="POST">
                    @csrf
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="nim" id="nim" placeholder="" class="bg-gray-50 border border-gray-300 text-gray-900 text-lg mb-5 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                        @error('nim')
                            <div class="text-red-500 text-sm mt-2 mb-5">{{ $message }}</div>
                        @enderror
                    </div>
                    <button type="submit" class="w-full text-white bg-green-600 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-lg px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Kirim</button>
                </form>
            </div>
        </div>
    </div>
